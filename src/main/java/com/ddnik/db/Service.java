...
public class Service implements IService {
    ...
    public List<WorkspaceDto> getWorkspacesByHourlyRate(BigDecimal minRate, BigDecimal maxRate) throws SQLException, SecurityException {
    ...
    public List<WorkspaceDto> getWorkspacesByName(String name) throws SQLException, SecurityException {
    ...
    public List<WorkspaceDto> getWorkspacesByStatus(boolean is_active) throws SQLException, SecurityException {
    ...
    public List<WorkspaceDto> getWorkspacesByType(long id) throws SQLException, SecurityException {
    ...
    public List<BookingDto> getBookings() throws SQLException, SecurityException {
    ...
    public List<BookingDto> getBookingsByWorkspaceId(WorkspaceDto workspace) throws SQLException, SecurityException {
    ...
    public List<WorkspaceTypesDto> getWorkspaceTypes() throws SQLException, SecurityException {
